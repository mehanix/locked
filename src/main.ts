...
const hall_texture_paths = [
  "/assets/usa_far.png",
  "/assets/usa_med.png",
  "/assets/usa_close.png",
];
const interactive_texture_paths = [
  "/assets/peephole.png",
  "/assets/clanta.png",
...
const textures = await Assets.load([
  ...hall_texture_paths,
  ...interactive_texture_paths,
  ...big_nameplate_texture_paths,
]);
...
(async () => {
  ...
  const interactive_sprites = interactive_texture_paths.map((path) => {
    ...
    sprite.position.set(
      interactive_sprite_positions[interactive_texture_paths.indexOf(path)].x,
      interactive_sprite_positions[interactive_texture_paths.indexOf(path)].y,
    );
    return sprite;
  });
  ...
  const hideNameplateFn = () => {
    big_nameplate_visible = !big_nameplate_visible;
    nameplate_sprite.visible = big_nameplate_visible;
  };
  const toggleNameplateFn = () => {
    console.log("clack");
    big_nameplate_visible = !big_nameplate_visible;
    nameplate_sprite.visible = big_nameplate_visible;
  };
